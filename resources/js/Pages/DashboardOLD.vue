...
const createdAtUTC = props.selectedNote.created_at
...
<template>
    ...
    <main class="min-h-[100svh] grid grid-cols-[15rem_1fr] bg-neutral-100 overflow-hidden">
        ...
        <form class="p-10 flex flex-col" @submit.prevent="sessionSelectedNote.put(route('notes.update', props.selectedNote.id))">
